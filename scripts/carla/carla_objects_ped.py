...
This code works for the bag file uploaded on the google drive(pedestrian cross). 
For other bag files, check origin, object id, frames etc.
'''
########################################### section 1 imports
import rospy
